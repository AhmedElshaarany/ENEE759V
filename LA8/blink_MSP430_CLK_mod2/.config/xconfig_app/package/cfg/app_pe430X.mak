...
package/cfg/app_pe430X.oe430X: export C_DIR=
package/cfg/app_pe430X.oe430X: PATH:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)
package/cfg/app_pe430X.oe430X: Path:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)

package/cfg/app_pe430X.se430X: | .interfaces
package/cfg/app_pe430X.se430X: package/cfg/app_pe430X.c package/cfg/app_pe430X.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) cle430X -n $< ...
...
package/cfg/app_pe430X.se430X: export C_DIR=
package/cfg/app_pe430X.se430X: PATH:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)
package/cfg/app_pe430X.se430X: Path:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)

clean,e430X ::
	-$(RM) package/cfg/app_pe430X.oe430X
	-$(RM) package/cfg/app_pe430X.se430X

app.pe430X: package/cfg/app_pe430X.oe430X package/cfg/app_pe430X.mak

clean::
	-$(RM) package/cfg/app_pe430X.mak
